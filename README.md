...
- `test/transitops/governor_test.cljk` -- unit tests of governor hard
  checks, scope exclusion, and the self-trip regression test
- `test/transitops/advisor_test.cljk` -- advisor proposal shape and
  consistency
- `test/transitops/phase_test.cljk` -- rollout phase logic
- `test/transitops/governor_contract_test.cljk` -- full graph
  integration, audit trail
- `test/transitops/store_contract_test.cljk` -- Store protocol and
